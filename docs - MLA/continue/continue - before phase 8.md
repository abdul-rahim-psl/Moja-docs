...
- **The canonical-record table holds with zero exceptions across 641 records and two capture windows** — and that is exactly why re-verifying it against live traffic is a Phase 8 checklist item rather than an assumption already banked (`plan.md` §14 Q2).
