...
Documentation-only, from `docs/meetings/17-sept-checkin-for-pending-items.md` (a status/pending-items
...
- **Two items need a call with Infotex** (spelled "Infitecs" in the raw meeting note; same party named
  throughout `docs/meetings/9-sept.md` and `MLA-deployment-kubernetes.md` §11 as the source of the DFSP
