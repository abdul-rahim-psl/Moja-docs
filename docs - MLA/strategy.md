...
| **Implementing Phase 6 — observability, metrics, alerting, ack latency** | `core-knowledge.md` §9 → `engineering-rules.md` §9 → `cch-crosscutting-user-stories.md` (US-MON-01, US-PERF-01; US-AUD-01/US-MON-02/US-PERF-02/US-SEC-01 are PPA- or infra-scoped, not MLA's build) → `plan.md` §9 |
